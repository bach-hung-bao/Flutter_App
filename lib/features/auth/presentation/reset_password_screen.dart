...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  void _handleResetPassword() async {
    setState(() {
      _newPassError = _newPassController.text.length < 6
    ...
    DialogUtils.showSuccessDialog(
      ...
      desc:
          'Bạn có thể sử dụng mật khẩu mới để đăng nhập vào White Hotel ngay bây giờ.',
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Vui lòng nhập mật khẩu mới để bảo vệ tài\nkhoản của bạn.',
                ...
                CustomTextField(
                  ...
                  onToggle: () =>
                      setState(() => _obsecureNewPass = !_obsecureNewPass),
                ),
                const SizedBox(height: 20),
